 ...
 */
final class Version20200416204948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE edicion (id INT AUTO_INCREMENT NOT NULL, encuentro_id INT DEFAULT NULL, operacion VARCHAR(50) NOT NULL, editor VARCHAR(60) NOT NULL, fecha DATE NOT NULL, INDEX IDX_655F7739E304C7C8 (encuentro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE competencia (id INT AUTO_INCREMENT NOT NULL, ciudad_id INT DEFAULT NULL, categoria_id INT DEFAULT NULL, organizacion_id INT DEFAULT NULL, inscripcion_id INT DEFAULT NULL, nombre VARCHAR(127) NOT NULL, fecha_ini DATE NOT NULL, fecha_fin DATE DEFAULT NULL, genero ENUM(\'MASCULINO\', \'FEMENINO\', \'MIXTO\'), max_competidores INT DEFAULT NULL, cant_grupos INT DEFAULT NULL, fase INT DEFAULT NULL, min_competidores INT DEFAULT NULL, fase_actual INT NOT NULL, frec_dias INT NOT NULL, estado ENUM(\'COMPETENCIA_SIN_INSCRIPCION\', \'COMPETENCIA_CON_INSCRIPCION\', \'COMPETENCIA_INSCRIPCION_ABIERTA\', \'COMPETENCIA_INSCRIPCION_CERRADA\', \'COMPETENCIA_INICIADA\', \'COMPETENCIA_PAUSADA\', \'COMPETENCIA_SUSPENDIDA\', \'COMPETENCIA_FINALIZADA\'), UNIQUE INDEX UNIQ_842C498A3A909126 (nombre), INDEX IDX_842C498AE8608214 (ciudad_id), INDEX IDX_842C498A3397707A (categoria_id), INDEX IDX_842C498A90B1019E (organizacion_id), UNIQUE INDEX UNIQ_842C498AFFD5FBD3 (inscripcion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE predio (id INT AUTO_INCREMENT NOT NULL, ciudad_id INT DEFAULT NULL, nombre VARCHAR(50) NOT NULL, direccion VARCHAR(150) NOT NULL, INDEX IDX_13E6D727E8608214 (ciudad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pais (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE competencia ADD CONSTRAINT FK_842C498AE8608214 FOREIGN KEY (ciudad_id) REFERENCES ciudad (id)');
        ...
        $this->addSql('ALTER TABLE predio ADD CONSTRAINT FK_13E6D727E8608214 FOREIGN KEY (ciudad_id) REFERENCES ciudad (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competencia DROP FOREIGN KEY FK_842C498AE8608214');
        $this->addSql('ALTER TABLE predio DROP FOREIGN KEY FK_13E6D727E8608214');
