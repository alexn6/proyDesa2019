 ...
 */
final class Version20191114210202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE encuentro (id INT AUTO_INCREMENT NOT NULL, competencia_id INT DEFAULT NULL, compuser1_id INT DEFAULT NULL, compuser2_id INT DEFAULT NULL, jornada_id INT DEFAULT NULL, juez_id INT DEFAULT NULL, campo_id INT DEFAULT NULL, turno_id INT DEFAULT NULL, grupo INT DEFAULT NULL, rdo_comp1 INT NOT NULL, rdo_comp2 INT NOT NULL, INDEX IDX_CDFA77FA9980C34D (competencia_id), INDEX IDX_CDFA77FA3AD9E (compuser1_id), INDEX IDX_CDFA77FA12B60270 (compuser2_id), INDEX IDX_CDFA77FA26E992D9 (jornada_id), INDEX IDX_CDFA77FA2515F440 (juez_id), INDEX IDX_CDFA77FAA17A385C (campo_id), INDEX IDX_CDFA77FA69C5211E (turno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE turno (id INT AUTO_INCREMENT NOT NULL, competencia_id INT DEFAULT NULL, hora DATE NOT NULL, INDEX IDX_E79767629980C34D (competencia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE predio (id INT AUTO_INCREMENT NOT NULL, competencia_id INT DEFAULT NULL, nombre VARCHAR(50) NOT NULL, direccion VARCHAR(150) NOT NULL, ciudad VARCHAR(150) NOT NULL, UNIQUE INDEX UNIQ_13E6D7273A909126 (nombre), INDEX IDX_13E6D7279980C34D (competencia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
