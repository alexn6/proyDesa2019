 ...
 */
final class Version20200221162342 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE competencia (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, organizacion_id INT DEFAULT NULL, inscripcion_id INT DEFAULT NULL, nombre VARCHAR(127) NOT NULL, fecha_ini DATE NOT NULL, fecha_fin DATE NOT NULL, ciudad VARCHAR(127) NOT NULL, genero ENUM(\'MASCULINO\', \'FEMENINO\', \'MIXTO\'), max_competidores INT DEFAULT NULL, cant_grupos INT DEFAULT NULL, fase INT DEFAULT NULL, min_competidores INT DEFAULT NULL, fase_actual INT NOT NULL, frec_dias INT NOT NULL, estado ENUM(\'COMPETENCIA_SIN_INSCRIPCION\', \'COMPETENCIA_INSCRIPCION_ABIERTA\', \'COMPETENCIA_INICIADA\', \'COMPETENCIA_FINALIZADA\'), UNIQUE INDEX UNIQ_842C498A3A909126 (nombre), INDEX IDX_842C498A3397707A (categoria_id), INDEX IDX_842C498A90B1019E (organizacion_id), UNIQUE INDEX UNIQ_842C498AFFD5FBD3 (inscripcion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inscripcion (id INT AUTO_INCREMENT NOT NULL, fecha_ini DATE NOT NULL, fecha_cierre DATE NOT NULL, monto INT DEFAULT NULL, requisitos VARCHAR(127) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
