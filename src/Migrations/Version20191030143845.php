 ...
 */
final class Version20191030143845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE encuentro (id INT AUTO_INCREMENT NOT NULL, competencia_id INT DEFAULT NULL, compuser1_id INT DEFAULT NULL, compuser2_id INT DEFAULT NULL, grupo INT NOT NULL, jornada VARCHAR(64) NOT NULL, INDEX IDX_CDFA77FA9980C34D (competencia_id), INDEX IDX_CDFA77FA3AD9E (compuser1_id), INDEX IDX_CDFA77FA12B60270 (compuser2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tipo_organizacion (id INT AUTO_INCREMENT NOT NULL, codigo VARCHAR(10) NOT NULL, nombre VARCHAR(127) NOT NULL, descripcion VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BF73525A20332D99 (codigo), UNIQUE INDEX UNIQ_BF73525A3A909126 (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
