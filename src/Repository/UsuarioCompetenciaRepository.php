...
class UsuarioCompetenciaRepository extends ServiceEntityRepository
{
  ...
  public function findCompetitionsFollowByUser($idUsuario)
  {
      $entityManager = $this->getEntityManager();
      $query = $entityManager->createQuery(
          '   SELECT c.id, c.fecha_ini, c.nombre, cat.nombre categoria, d.nombre deporte, org.nombre tipo_organizacion, cd.nombre as ciudad, c.genero, c.fase_actual, c.estado, r.nombre rol
              FROM App\Entity\Competencia c
              INNER JOIN App\Entity\UsuarioCompetencia uc
              WITH uc.competencia = c.id
              INNER JOIN App\Entity\Categoria cat
  ...
  public function findCompetitionsOrganizeByUser($idUsuario)
  {
      $entityManager = $this->getEntityManager();
      $query = $entityManager->createQuery(
       '   SELECT c.id, c.fecha_ini, c.nombre, cat.nombre categoria, cat.duracion_default duracionDefault, d.nombre deporte, org.nombre tipo_organizacion, cd.nombre as ciudad, c.genero, c.fase_actual, c.estado, r.nombre rol
           FROM App\Entity\Competencia c
           INNER JOIN App\Entity\UsuarioCompetencia uc
           WITH uc.competencia = c.id
           INNER JOIN App\Entity\Categoria cat
